...
export default function MobileMenu({isOpen, handleClose}: {isOpen: boolean, handleClose: () => void}) {
    return (
        <>
            ...
            {/** Mobile Menu */}
            <div className={`w-3/4 bg-gray-300 border-b-1 border-b-gray-200 h-full fixed top-0 left-0 z-50 transition-all duration-500 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-[-100%]'}`}>
                <div className=''>
